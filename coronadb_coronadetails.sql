...
--
-- Table structure for table `coronadetails`
--

DROP TABLE IF EXISTS `coronadetails`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `coronadetails` (
  `id` int NOT NULL AUTO_INCREMENT,
  `customerId` varchar(9) NOT NULL,
  `DateReceivedA` date DEFAULT NULL,
  `ManufacturerA` varchar(20) DEFAULT NULL,
  `DateReceivedB` date DEFAULT NULL,
  `ManufacturerB` varchar(20) DEFAULT NULL,
  `DateReceivedC` date DEFAULT NULL,
  `ManufacturerC` varchar(20) DEFAULT NULL,
  `DateReceivedD` date DEFAULT NULL,
  `ManufacturerD` varchar(20) DEFAULT NULL,
  `DateOfPositiveAnswer` date DEFAULT NULL,
...
--
-- Dumping data for table `coronadetails`
--
